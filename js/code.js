		...
		xhr.onreadystatechange = function() 
		{
			if (this.readyState == 4 && this.status == 200) 
			{
				...
				{	
					...
					contactList += `</strong><div class='d-grid gap-2 d-md-flex justify-content-md-end'><button type='button' id='updateButton' class='btn btn-outline-primary p-2 bd-highlight' onclick='setUpPrev(${JSON.stringify(str)});'>Update</button>`;
